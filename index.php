...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="bootstrap-4.0.0/dist/css/bootstrap.min.js">
    ...
    <div class="container">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">Thương hiệu</a>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item">
                    <img src="images/halo.jpg" alt="Chicago">
                </div>

                <div class="item">
                    <img src="images/ARK-450.jpg" alt="New York">
                </div>
            </div>
        ...
        <div class="container">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 padding-0">
                <div class="vertical-menu">
                    ...
                    <a href="index.php">Tai nghe</a>
                    <a href="index.php">Phụ kiện</a>
                ...
                <div class="list-group">
                    ...
                    <a href="news.php" class="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 hover-sanpham">
                       <a class="img-reponsive" href="detail-products.php">
                           <img src="images/GTA5.jpg" width="100%">
                           <p class="title-product">Grand Theft Auto V - GTA V</p>
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 hover-sanpham">
                       <a class="img-reponsive" href="detail-products.php">
                           <img src="images/ARK-450.jpg" width="100%">
                           <p class="title-product">ARK Servival</p>
                           <p class="price">450.000 VNĐ</p>
                           <input type="submit" class="button-styling" name="dathang-submit" value="Đặt hàng">
                       </a>
                    </div>
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 hover-sanpham">
                       <a class="img-reponsive" href="detail-product.php">
                           <img src="images/Northgard-118.jpg" width="100%">
                           <p class="title-product">Northgard 2018</p>
                           <p class="price">118.000 VNĐ</p>
                           <input type="submit" class="button-styling" name="dathang-submit" value="Đặt hàng">
                       </a>
                    </div>
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 hover-sanpham">
                       <a class="img-reponsive" href="detail-product.php">
                           <img src="images/Project Hospital-145.jpg" width="100%">
                           <p class="title-product">Project Hospital</p>
                           <p class="price">145.000 VNĐ</p>
                           <input type="submit" class="button-styling" name="dathang-submit" value="Đặt hàng">
                       </a>
                    </div>
                    <hr class="col-lg-12 col-md-12 col-sm-12" style="color: black">
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 hover-sanpham">
                       <a class="img-reponsive" href="detail-products.php">
                           <img src="images/GodOfWar_Slider.jpg" width="100%">
                           <p class="title-product">God of War 2018</p>
                           <p class="price">3.500.000 VNĐ</p>
                           <input type="submit" class="button-styling" name="dathang-submit" value="Đặt hàng">
                       </a>
                    </div>
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 hover-sanpham">
                       <a class="img-reponsive" href="detail-products.php">
                           <img src="images/The Incredible-58.jpg" width="100%">
                           <p class="title-product">The Incredible</p>
                           <p class="price">58.000 VNĐ</p>
                           <input type="submit" class="button-styling" name="dathang-submit" value="Đặt hàng">
                       </a>
                    </div>
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 hover-sanpham">
                ...
                <div class="col-lg-12">
                    <div class="col-md-3">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="detail-products.php">Về chúng tôi</a></li>
                            <li><a href="news.php">Tin tức</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3">
