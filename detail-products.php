            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                ...
                <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Đĩa game</a></li>
                        <li class="breadcrumb-item active" aria-current="page">God of war 2018</li>
                      </ol>
                </nav>
                <div class="panel panel-primary">
                    <div class="panel-body">
                        Đĩa game God of war 2018
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                       <img src="images/disk.jpg" width="100%" class="img img-responsive">
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                       <ul class="nav nav-tabs">
                          <li class="active"><a data-toggle="tab" href="#tomtat">Tóm tắt</a></li>
                          <li><a data-toggle="tab" href="#baohanh">Bảo hành</a></li>
                          <li><a data-toggle="tab" href="#quydinh">Quy định đổi trả</a></li>
                           <li><a data-toggle="tab" href="#khuyenmai">Khuyến mãi</a></li>
                        </ul>

                        <div class="tab-content">
                          <div id="tomtat" class="tab-pane fade in active">
                            <h3>Tóm tắt</h3>
                            <p>Some content.</p>
                          </div>
                          ...
                          <div id="quydinh" class="tab-pane fade">
